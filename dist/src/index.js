...
app.get("/health", async (c) => {
    ...
    try {
        ...
        console.log(`[${timestamp}] Database connection successful. Sample query returned ${testQuery.length} records`);
    }
    catch (error) {
    ...
    try {
        ...
        console.log(`[${timestamp}] Admin table accessible. Found ${adminCount.length} records (limited to 1)`);
    }
    catch (error) {
    ...
    console.log(`[${timestamp}] Health check completed. Status: ${healthData.status}`);
